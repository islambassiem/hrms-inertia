...
return new class extends Migration
{
    ...
    {
        Schema::create('qualification_specialties', function (Blueprint $table): void {
            $table->id();
            $table->string('name_en')->index();
            $table->string('name_ar')->index();
            $table->string('code');
            $table->foreignIdFor(SpecialtyCategory::class, 'category_id')->constrained();
    ...
    {
        Schema::dropIfExists('qualification_specialties');
    }
};
