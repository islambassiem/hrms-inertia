...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/islam/prog/2026/hrms-inertia/public/storage' => 'string',
...
'cache.prefix','cache.serializable_classes','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/islam/prog/2026/hrms-inertia/public/storage','fortify.guard','fortify.middleware',
...
'ide-helper.post_migrate','inertia.ssr.enabled','inertia.ssr.url','inertia.pages.paths','inertia.pages.extensions',
'inertia.testing.ensure_pages_exist','inertia.expose_shared_prop_keys','inertia.history.encrypt','logging.default','logging.deprecations.channel',
...
'permission.models.permission','permission.models.role','permission.models.team','permission.models.default_model','permission.table_names.roles',
...
'query-builder.delimiter','query-builder.filter_value_splitting_enabled','query-builder.suffixes.count','query-builder.suffixes.exists','query-builder.suffixes.min',
'query-builder.suffixes.max','query-builder.suffixes.sum','query-builder.suffixes.avg','query-builder.disable_invalid_filter_query_exception','query-builder.disable_invalid_sort_query_exception',
'query-builder.disable_invalid_include_query_exception','query-builder.convert_relation_names_to_snake_case_plural','query-builder.convert_relation_table_name_strategy','query-builder.convert_field_names_to_snake_case','queue.default',
...
'debugbar.debug_backtrace_limit','boost.enabled','boost.browser_logs_watcher','boost.executable_paths.php','boost.executable_paths.composer',
'boost.executable_paths.npm','boost.executable_paths.vendor_bin','boost.executable_paths.current_directory','passkeys.relying_party_id','passkeys.allowed_origins',
'passkeys.user_handle_secret','passkeys.timeout','passkeys.guard','passkeys.middleware','passkeys.throttle',
'passkeys.redirect','mcp.redirect_domains','mcp.custom_schemes','mcp.authorization_server','activitylog.enabled',
'activitylog.clean_after_days','activitylog.default_log_name','activitylog.default_auth_driver','activitylog.include_soft_deleted_subjects','activitylog.activity_model',
'activitylog.default_except_attributes','activitylog.buffer.enabled','activitylog.actions.log_activity','activitylog.actions.clean_log','structure-discoverer.ignored_files',
